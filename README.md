...
| <a name="input_snapshot_identifier"></a> [snapshot\_identifier](#input\_snapshot\_identifier) | The identifier for the DB snapshot or DB cluster snapshot to restore from.<br/>If provided, the RDS instance will be created from this snapshot and engine/db\_name/username/password will be ignored.<br/>If null, a fresh RDS instance will be created. | `string` | `null` | no |
